...
const UnifiedCheck: React.FC<UnifiedCheckPropsExtended> = ({
  ...
  const baselinesRef = React.useRef<{ ear: number | null; noseX: number | null }>({
    ear: null,
    noseX: null,
  });
